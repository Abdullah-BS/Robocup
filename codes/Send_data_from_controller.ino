...
void processGamepad(ControllerPtr ctl) {
  ...
  if (ctl->a()) Serial.println("Button A (Cross) pressed");
  if (ctl->b()) Serial.println("Button B (Circle) pressed");
  if (ctl->x()) Serial.println("Button X (Square) pressed");
  if (ctl->y()) Serial.println("Button Y (Triangle) pressed");

  if (ctl->l1()) Serial.println("L1 pressed");
  if (ctl->r1()) Serial.println("R1 pressed");

  if (ctl->l2()) Serial.printf("L2 pressed - value: %d\n", ctl->l2());
  if (ctl->r2()) Serial.printf("R2 pressed - value: %d\n", ctl->r2());



  if (ctl->miscButtons()) Serial.printf("Misc buttons: 0x%02x\n", ctl->miscButtons());

  Serial.println(); // spacing between updates
